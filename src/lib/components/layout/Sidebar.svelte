			...
			>
				<div class="pb-1">
					...
					>
						...
						>
							<div
								class="self-center flex {mobile ? 'size-10' : 'size-[calc(30px*var(--app-text-scale,1))]'} items-center justify-center rounded-lg transition group-hover:bg-gray-50 dark:group-hover:bg-gray-900"
							>
