		...
		>
			...
			>
				<div class="pb-1">
					...
					>
						<button
							class="flex {mobile ? 'size-10' : 'size-8.5'} items-center justify-center transition group {isWindows
								? 'cursor-pointer'
								: 'cursor-[e-resize]'}"
	...
	{#if visible || !$mobile}
		...
		>
			...
			>
				...
				>
					<a
						class="flex items-center rounded-xl {mobile ? 'size-10' : 'size-8.5'} h-full justify-center hover:bg-gray-100 dark:hover:bg-gray-900 transition no-drag-region"
						href="/"
						draggable="false"
					...
					>
						<button
							class="flex {mobile ? 'size-10' : 'size-[1.875rem]'} justify-center items-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-900 transition {isWindows
								? 'cursor-pointer'
								: 'cursor-[w-resize]'}"
							on:click={() => {
								showSidebar.set(!$showSidebar);
				...
				>
					<div class="pb-1">
						<div class="px-1 flex justify-center text-gray-700 dark:text-gray-300">
							<a
								id="sidebar-new-chat-button"
								class="group grow flex items-center space-x-2 rounded-xl {mobile ? 'px-3.5 py-3' : 'px-2 py-1.5'} hover:bg-gray-100 dark:hover:bg-gray-900 transition outline-none"
								href="/"
								draggable="false"
								on:click={newChatHandler}
								aria-label={$i18n.t('New Chat')}
							>
								...
								<div class="flex flex-1 self-center translate-y-[0.5px]">
									<div class=" self-center {mobile ? 'text-[15px] leading-5' : 'text-[0.8125rem] leading-5'}">{$i18n.t('New Chat')}</div>
								</div>
						...
						<div class="px-1 flex justify-center text-gray-700 dark:text-gray-300">
							...
							>
								...
								<div class="flex flex-1 self-center translate-y-[0.5px]">
									<div class=" self-center {mobile ? 'text-[15px] leading-5' : 'text-[0.8125rem] leading-5'}">{$i18n.t('Search')}</div>
								</div>
									...
									>
										...
										>
											...
											<div class="flex self-center translate-y-[0.5px]">
												<div class=" self-center {mobile ? 'text-[15px] leading-5' : 'text-[0.8125rem] leading-5'}">
													{$i18n.t(meta.label)}
												</div>
											</div>
										</a>
					...
					<div class="flex flex-col">
						{#if $user !== undefined && $user !== null}
							...
							>
								<button
									type="button"
									class=" flex items-center rounded-xl {mobile ? 'py-3 px-3' : 'py-1.5 px-1.5'} w-full hover:bg-gray-100 dark:hover:bg-gray-900 transition"
									aria-label={$i18n.t('User menu')}
								>
