	...
	>
		...
		<div class="w-full group">
			<div
				...
				class="relative w-full {$mobile ? 'py-3 px-2.5' : 'py-1 px-1.5'} rounded-xl flex items-center gap-1.5 hover:bg-gray-100 dark:hover:bg-gray-900 transition {$selectedFolder?.id ===
			...
			>
				<button
					class="text-gray-600 dark:text-gray-400 transition-all {$mobile ? 'p-2' : 'p-1'} hover:bg-gray-100 dark:hover:bg-gray-900 rounded-lg"
