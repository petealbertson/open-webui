			...
			<div class="w-full flex flex-col gap-2.5">
				<div class="w-full">
					...
					<div class="w-full mt-1">
						<input
							class={modal
								? 'input-plain w-full text-sm bg-transparent outline-hidden placeholder:text-gray-300 dark:placeholder:text-gray-700'
				...
				<div>
					...
					<div class="w-full mt-1">
						<textarea
							class={modal
								? 'input-plain w-full resize-none text-sm bg-transparent outline-hidden placeholder:text-gray-300 dark:placeholder:text-gray-700'
