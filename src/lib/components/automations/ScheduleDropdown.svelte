...
<Dropdown bind:show={showDropdown} {side} {align}>
	...
	>
		...
		<div class="px-1.5 py-0.5">
			<select
				class="input-plain w-full h-[1.6875rem] bg-transparent rounded-xl text-[0.8125rem] px-1.5 outline-hidden"
		...
		{#if frequency === 'CUSTOM'}
			<div class="px-2 pb-2">
				<input
					...
					class="input-plain w-full bg-transparent outline-hidden text-[0.8125rem] placeholder:text-gray-400 dark:placeholder:text-gray-600"
