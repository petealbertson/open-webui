		...
		<DropdownMenu className="w-70 max-h-72 overflow-hidden transition">
			{#if tab === ''}
				...
				>
					...
					>
						<button
							class="flex w-full gap-2 items-center {$mobile ? 'h-11' : 'h-[1.6875rem]'} px-2 text-[13px] font-normal select-none cursor-pointer hover:bg-gray-50/40 dark:hover:bg-gray-800/40 rounded-xl {!fileUploadEnabled
								? 'opacity-50'
								: ''}"
							type="button"
							on:click={() => {
					...
					>
						<button
							class="flex w-full gap-2 items-center {$mobile ? 'h-11' : 'h-[1.6875rem]'} px-2 text-[13px] font-normal select-none cursor-pointer hover:bg-gray-50/40 dark:hover:bg-gray-800/40 rounded-xl {!webUploadEnabled
								? 'opacity-50'
								: ''}"
							type="button"
							on:click={() => {
					...
					>
						<button
							class="flex gap-2 w-full items-center {$mobile ? 'h-11' : 'h-[1.6875rem]'} px-2 text-[13px] font-normal select-none cursor-pointer hover:bg-gray-50/40 dark:hover:bg-gray-800/40 rounded-xl {!fileUploadEnabled
								? 'opacity-50'
								: ''}"
							on:click={() => {
								if (fileUploadEnabled) {
					...
					>
						<button
							class="flex gap-2 w-full items-center {$mobile ? 'h-11' : 'h-[1.6875rem]'} px-2 text-[13px] font-normal cursor-pointer hover:bg-gray-50/40 dark:hover:bg-gray-800/40 rounded-xl {!fileUploadEnabled
								? 'opacity-50'
								: ''}"
							on:click={() => {
								tab = 'knowledge';
					...
					{#if fileUploadEnabled}
						{#if $config?.features?.enable_google_drive_integration}
							<button
								class="flex w-full gap-2 items-center {$mobile ? 'h-11' : 'h-[1.6875rem]'} px-2 text-[13px] font-normal select-none cursor-pointer hover:bg-gray-50/40 dark:hover:bg-gray-800/40 rounded-xl"
								type="button"
								on:click={() => {
			...
			{:else if tab === 'knowledge'}
				<div class="flex max-h-72 flex-col overflow-hidden" in:fly={{ x: 20, duration: 150 }}>
					<button
						class="flex w-full shrink-0 justify-between gap-2 items-center {$mobile ? 'h-11' : 'h-[1.6875rem]'} px-2 text-[13px] font-normal select-none cursor-pointer rounded-xl hover:bg-gray-50/40 dark:hover:bg-gray-800/40"
						on:click={() => {
							tab = '';
						}}
					>
			...
			{:else if tab === 'microsoft_onedrive'}
				<div in:fly={{ x: 20, duration: 150 }}>
					<button
						class="flex w-full justify-between gap-2 items-center {$mobile ? 'h-11' : 'h-[1.6875rem]'} px-2 text-[13px] font-normal select-none cursor-pointer rounded-xl hover:bg-gray-50/40 dark:hover:bg-gray-800/40"
						on:click={() => {
							tab = '';
						}}
					>
					...
					{#if $config?.features?.enable_onedrive_personal}
						<button
							class="flex w-full gap-2 items-center {$mobile ? 'h-11' : 'h-[1.6875rem]'} px-2 text-[13px] font-normal select-none cursor-pointer hover:bg-gray-50/40 dark:hover:bg-gray-800/40 rounded-xl text-left"
							type="button"
							on:click={() => {
