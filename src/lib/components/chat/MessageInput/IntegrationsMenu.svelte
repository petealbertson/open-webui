<script lang="ts">
	...
	import { user, mobile, tools as _tools, skills as _skills, toolServers } from '$lib/stores';
				...
				>
					{#if tools}
						{#if Object.keys(tools).length > 0}
							<button
								class="flex w-full justify-between gap-2 items-center {$mobile ? 'h-11' : 'h-[1.6875rem]'} px-2 text-[0.8125rem] font-normal cursor-pointer rounded-xl hover:bg-gray-50/40 dark:hover:bg-gray-800/40"
