								...
								<div class="flex min-w-0 shrink-0 items-center gap-0.5">
									...
									{#if modelFilterItems.length > 0}
										<TagSelector
											...
											itemClass="flex {$mobile ? 'h-11' : 'h-[1.6875rem]'} w-full cursor-pointer items-center gap-2 rounded-xl bg-transparent px-2 text-[0.8125rem] capitalize hover:bg-gray-50/40 hover:text-gray-900 dark:hover:bg-gray-800/40 dark:hover:text-gray-100"
