								...
								<div class="ml-1 self-end flex items-center flex-1 min-w-0">
									...
									>
										<button
											...
											class="bg-transparent hover:bg-gray-100 text-gray-700 dark:text-white dark:hover:bg-gray-800 rounded-full {$mobile ? 'size-9' : 'size-[1.875rem]'} flex justify-center items-center outline-hidden focus:outline-hidden shrink-0"
											...
											<div class="ml-1 flex gap-1.5 shrink-0">
												<Tooltip content={$i18n.t('Valves')} placement="top">
													<button
														...
														class="bg-transparent hover:bg-gray-100 text-gray-700 dark:text-white dark:hover:bg-gray-800 rounded-full {$mobile ? 'size-9' : 'size-[1.875rem]'} flex justify-center items-center outline-hidden focus:outline-hidden"
														on:click={() => {
									...
									{#if hasChatVariables}
										<Tooltip content={$i18n.t('Chat Variables')} placement="top">
											<button
												...
												class="flex {$mobile ? 'size-9' : 'size-[1.875rem]'} shrink-0 items-center justify-center rounded-full bg-transparent text-gray-500 transition-colors hover:text-gray-800 focus:outline-hidden dark:text-gray-400 dark:hover:text-gray-100"
										...
										<div class=" flex items-center">
											<Tooltip content={$i18n.t('Stop')}>
												<button
													...
													class="bg-white hover:bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-800 transition rounded-full {$mobile ? 'p-2' : 'p-[5px]'}"
													on:click={() => {
														stopResponse();
													}}
												>
											...
											{#if $_user?.role === 'admin' || ($_user?.permissions?.chat?.stt ?? true)}
												...
												<Tooltip content={$i18n.t('Dictate')}>
													<button
														...
														class=" text-gray-600 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-200 transition rounded-full {$mobile ? 'p-2' : 'p-1.5'} self-center mr-0.5"
														type="button"
														on:click={async () => {
															try {
										...
										{#if prompt === '' && files.length === 0 && ($_user?.role === 'admin' || ($_user?.permissions?.chat?.call ?? true))}
											<div class=" flex items-center">
												...
												<Tooltip content={$i18n.t('Voice mode')}>
													<button
														class=" bg-black text-white hover:bg-gray-900 dark:bg-white dark:text-black dark:hover:bg-gray-100 transition rounded-full {$mobile ? 'p-2' : 'p-[5px]'} self-center"
														type="button"
														on:click={async () => {
												...
												>
													<button
														...
														class="{!(prompt === '' && files.length === 0) || uploadPending
															...
															: 'text-white bg-gray-200 dark:text-gray-900 dark:bg-gray-700 disabled'} transition rounded-full {$mobile ? 'p-2' : 'p-[5px]'} self-center"
														type="submit"
